...
//		}
	...
	public void create_objects()
	{
		...
		myball = new Circle(myworld, 0, BodyType.DynamicBody, 1, 0.6f, 0.7f,
				GlobalSettings.SCREEN_WIDTH * 0.33f, 500, 0, 0, 0, "",
				"images/ball.png", "", 32);
...
//		objmanager.objects.add(car);
	...
	public void render()
	{
		...
		//Gdx.app.log("Accumulator  ",Double.toString(accumulator) + "    "+ Double.toString(frameTime));
